    ...
    <div class="container-fluid p-5">
        ...
        <div class="row d-flex justify-content-center">
            ...
            <div class="col-12 col-lg-8">
                    ...
                    <div class="p-4 shadow-sm rounded mt-4 bg-white">
                        <div class="row d-flex justify-content-center">
                            <div class="px-4 alert alert-warning">
                                ...
                                <p>Your company, {{ $employer->company->company_name }}, is currently under review by our
                                    administrators. Once approved, you will be able to post jobs and access all features.
                                </p>
                            </div>
                            <div class="row pt-4">
                                <div class="col">
                ...
                @elseif($employer?->company->status === 'Approved')
                    <div class="p-4 shadow-sm rounded mt-4 bg-white">
                        <div class="row">
                ...
                @elseif(Auth::user() || $employer?->company->status === 'Rejected')
                <div class="p-4 shadow-sm rounded mt-4 bg-white">
                    <div class="row d-flex justify-content-center">
                        <div class="px-4 alert alert-light border border-danger">
                            ...
                            <p class="text-danger">Your company profile, {{ $employer->company->company_name }}, has been rejected. Please update your information, then resubmit your profile.
                            </p>
                        </div>
                        <div class="row pt-4">
                            <div class="col">
