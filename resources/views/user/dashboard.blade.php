        ...
        <div class="container py-5">
            ...
            <div class="row d-flex justify-content-evenly my-2">
                @foreach ($industries as $industry)
                    <div class="col-6 col-md-3 bg-white mb-3">
                        <a href="{{ route('list', ['category' => $industry->id]) }}"
                            class="text-decoration-none text-black">
                            <div
                                class="d-flex flex-column align-items-center industries border border-2 rounded border-secondary-subtle p-3 pb-1">
            ...
            <div class="row d-flex justify-content-evenly my-2">
                @foreach ($companies as $company)
                    <div class="col-6 col-md-3 pe-1">
                        <a href="{{ route('company.detail', $company->id) }}"
                            class="text-decoration-none text-black">
                            <div
                                class="m-2 d-flex flex-column align-items-center border border-2 rounded border-secondary-subtle p-4 pb-1">
                                <div class=" mb-3">
                                    <img src="{{ asset('images/' . $company->company_logo) }}" class="img-fluid company-logo">
                                </div>
                ...
                <div class="col-6 col-md-3 pe-1">
                    <div
                        class="m-2 d-flex flex-column align-items-center border border-2 rounded border-secondary-subtle p-4 pb-1">
                        <div class=" mb-3">
                            <img src="{{ asset('images/event.jpg') }}" class="img-fluid company-logo">
                        </div>
                        <h5>Facebook</h5>
                    </div>
                </div>
